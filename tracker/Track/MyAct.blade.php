    ...
    <div class="card-body pt-3 bg-light shadow-lg table-responsive">
        {{ HeaderBtn($Toggle="New", $Class="btn-danger", $Label="New Activity", $Icon="fa-plus")}}
        ...
        <table class=" mytable table table-rounded table-bordered  border gy-3 gs-3">
            ...
            <tbody>
                ...
                <tr>
                   ...
                   </td> <td><a data-bs-toggle="modal" href="#Update{{ $data->id }}" class="btn btn-sm btn-dark edit" href="#">
             ...
             <td>
                    ...
                    <a data-route="{{ route('MassDelete', ['id' => $data->id, 'TableName' => 'trackings']) }}"
                        ...
                        class="btn deleteConfirm btn-danger btn-sm btn-shadow"> <i
                            class="fas me-1  fa-trash" aria-hidden="true"></i>  </a>
             </td>
